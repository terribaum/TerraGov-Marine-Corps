...
/obj/item/storage/holster/backholster/rpg
	...
	holsterable_allowed = list(/obj/item/weapon/gun/launcher/rocket/recoillessrifle,/obj/item/weapon/gun/launcher/rocket/sadar,/obj/item/weapon/gun/launcher/rocket/m57a4,)
	bypass_w_limit = list(/obj/item/weapon/gun/launcher/rocket/recoillessrifle,/obj/item/weapon/gun/launcher/rocket/sadar,/obj/item/weapon/gun/launcher/rocket/m57a4,)
	///only one RR per bag
	storage_type_limits = list(/obj/item/weapon/gun/launcher/rocket/recoillessrifle = 1,/obj/item/weapon/gun/launcher/rocket/m57a4 = 1,/obj/item/weapon/gun/launcher/rocket/sadar  = 1,)
	can_hold = list(
...
/obj/item/storage/holster/backholster/rpg/update_icon_state()
    //sets the icon to full or empty
	.=..()
	for (var/gun_to_check in contents)
		if(istype(gun, obj/item/weapon/gun/launcher/rocket/m57a4))
			icon_state = "marine_rocket_m57_full"
		if(istype(gun, obj/item/weapon/gun/launcher/rocket/sadar))
			icon_state = "marine_rocket_m5_full"
    //sets the item state to match the icon state
		item_state = icon_state 
//one slot holsters 
