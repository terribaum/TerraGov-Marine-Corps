...
/obj/item/clothing/suit/storage/xenonauten/vestcoat
	name = "Armored coat"
	desc = "Uneffective.Stylish.Attractive."
	soft_armor = list("melee" = 40, "bullet" = 40, "laser" = 50, "energy" = 50, "bomb" = 35, "bio" = 25, "rad" = 5, "fire" = 15, "acid" = 25)
	icon_state = "vestcoat"
	item_state = "vestcoat"
	item_icons = list(slot_wear_suit_str = 'icons/mob/suit_1.dmi')
	flags_armor_protection = CHEST|ARMS|LEGS
	slowdown = 0.25
	time_to_equip = 2 SECONDS
	time_to_unequip = 1 SECONDS
...
/obj/item/storage/internal/general
	max_storage_space = 6
	storage_slots = 2
